...
pip3 install colour #for color support on the flex bulb
pip3 install requests #for getting weather data
sudo pacman -Syu
sudo pacman -S espeak #for generating voice synth file
sudo pacman -S libgfortran5 #for some linux distros neading audio support
sudo pacman -S libgfortran3 #for some linux distros neading audio support
sudo pacman -S libatlas-base-dev #for some linux distros neading audio support
